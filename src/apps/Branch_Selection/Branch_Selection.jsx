...
export default function WelcomeScreen() {
  ...
  const menuItems = [
    ...
    { icon: GitPullRequest, title: "Select Pull Request", desc: "Choose the PR or branch you want the AI to review.", active: true },
  ...
  <div className="min-h-screen flex flex-col items-start justify-center ml-15 bg-neutral-50 px-4">
    <div className="w-full max-w-md">
      ...
      <p className="text-gray-600 mb-4 text-left text-sm">
        Integrate your repositories to enable AI-powered code reviews and suggestions
      </p>
      <p className="text-xs text-green-600 font-semibold mb-1">Connected as "angelica_singh"</p>

      <div className="bg-white rounded-xl border border-b border-neutral-200 w-full p-5 mb-4 space-y-4">
        <div>
          ...
          <select className="w-full border border-gray-300 rounded-md p-2 text-sm">
            ...
            <option value="PR-1">PR-1: Fix header bug</option>
            <option value="PR-2">PR-2: Add login feature</option>
            <option value="PR-3">PR-3: Update README</option>
          </select>
        </div>
        ...
        <div className="flex flex-col gap-2">
            ...
            <Checkbox id="terms-1" className="mt-1" defaultChecked />
            <label htmlFor="terms-1" className="text-sm font-semibold text-black">
I Agree to the following Conditions           
</label>
          </div>
                      <p className="text-xs text-gray-500">Read Access to Repository, Write Access for AI Generations, and Post Comments on Pull Requests.</p>
